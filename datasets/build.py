...
from .bases import ImageDataset, ImagePairDataset, TextDataset, ImageTextDataset, ImageTextMLMDataset
...
def collate(batch):
    ...
    for k, v in dict_batch.items():
        if isinstance(v[0], int):
            ...
            batch_tensor_dict.update({k: None})
        else:
...
def build_dataloader(args, tranforms=None):
    ...
    if args.training:
        ...
        if dataset.type == "single":
            ...
            val_img_set = ImagePairDataset(ds['image_pids'], ds['img_paths'], ds['pair_img_paths'],
                                   val_transforms)
        ...
        if dataset.type == "single":
            ...
            test_img_set = ImagePairDataset(ds['image_pids'], ds['img_paths'], ds['pair_img_paths'],
                                    test_transforms)
